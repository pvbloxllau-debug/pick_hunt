    ...
    <body class="h-full flex flex-col font-sans text-gray-800" data-ws-user="{WS_USER_VAL}">
        ...
        <div id="mobile-report-modal"
            ...
            <div id="report-modal-sheet"
                ...
                <div style="padding:12px 20px 0;">
                    ...
                    <div style="display:flex;align-items:center;justify-content:space-between;padding-bottom:12px;
                        ...
                        <div style="display:flex;align-items:center;gap:10px;">
                            <!-- Dot rojo pulsante -->
                            <span style="width:9px;height:9px;border-radius:50%;background:#d13438;
                                         animation:pulse 1.5s infinite;flex-shrink:0;"></span>
                            <h3 style="font-size:15px;font-weight:800;color:#111827;margin:0;">Reportar Faltante</h3>
                        </div>
                        <button onclick="closeReportModal()"
                                style="background:#f9fafb;border:none;border-radius:10px;
                ...
                <form id="mobile-report-form" action="/api/hunts" method="post"
                      enctype="multipart/form-data"
                      style="padding:16px 20px 24px;display:flex;flex-direction:column;gap:14px;"
                      onsubmit="return submitReportModal(event)">

                    <!-- ITEM / CODIGO -->
                    <div>
                        <label style="display:block;font-size:10px;font-weight:700;color:#6b7280;
                                      text-transform:uppercase;letter-spacing:.05em;margin-bottom:6px;">Codigo / Item</label>
                        <div id="barcode-wrap"
                             style="display:flex;align-items:center;gap:8px;
                            ...
                            <input type="text" name="barcode" required
                                   placeholder="Ej: 7802100004567"
                                   style="flex:1;border:none;outline:none;background:transparent;
                                          padding:10px 0;font-size:13px;color:#111827;min-width:0;"
                                   onfocus="var w=document.getElementById('barcode-wrap');
                                            w.style.borderColor='#d13438';
                                            w.style.boxShadow='0 0 0 3px rgba(209,52,56,.10)';
                                            w.style.background='#fff';"
                    ...
                    <div>
                        <label style="display:block;font-size:10px;font-weight:700;color:#6b7280;
                                      text-transform:uppercase;letter-spacing:.05em;margin-bottom:6px;">Descripcion del Producto</label>
                        <div id="desc-wrap"
                             style="display:flex;align-items:center;gap:8px;
                                    border:1.5px solid #e5e7eb;border-radius:12px;
                                    background:#f9fafb;padding:0 12px;
                            ...
                            <input type="text" name="item_name" required
                                   placeholder="Ej: Soprole Leche Entera 1L"
                                   style="flex:1;border:none;outline:none;background:transparent;
                                          padding:10px 0;font-size:13px;color:#111827;min-width:0;"
                                   onfocus="var w=document.getElementById('desc-wrap');
                                            w.style.borderColor='#d13438';
                    ...
                    <div>
                        <label style="display:block;font-size:10px;font-weight:700;color:#6b7280;
                                      text-transform:uppercase;letter-spacing:.05em;margin-bottom:6px;">Cantidad</label>
                        <div id="qty-wrap"
                             style="display:flex;align-items:center;gap:8px;
                                    border:1.5px solid #e5e7eb;border-radius:12px;
                                    background:#f9fafb;padding:0 12px;width:120px;
                                    transition:border-color .2s,box-shadow .2s,background .2s;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="none"
                                 viewBox="0 0 24 24" stroke="#9ca3af" stroke-width="2" style="flex-shrink:0;">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M7 20h2m4 0h2M5 10h14M5 10a2 2 0 01-2-2V6a2 2 0 012-2h14
                                       a2 2 0 012 2v2a2 2 0 01-2 2M5 10v8a2 2 0 002 2h10a2 2 0 002-2v-8"/>
                            </svg>
                            <input type="number" name="quantity" min="1" max="100" value="1" required
                                   style="flex:1;border:none;outline:none;background:transparent;
                                          padding:10px 0;font-size:13px;color:#111827;min-width:0;
                    ...
                    <div>
                        <label style="display:block;font-size:10px;font-weight:700;color:#6b7280;
                                      text-transform:uppercase;letter-spacing:.05em;margin-bottom:8px;">Foto del Producto <span style="font-weight:400;text-transform:none;color:#9ca3af;">(opcional)</span></label>
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
                            <button type="button" onclick="triggerCamera()"
                                ...
                                <span style="font-size:11px;font-weight:700;color:#374151;">Camara</span>
                            </button>
                            ...
                            <button type="button" onclick="triggerGallery()"
                                ...
                                <span style="font-size:11px;font-weight:700;color:#374151;">Galeria</span>
                            </button>
                        </div>
                    ...
                    <button type="submit"
                            style="width:100%;display:flex;align-items:center;justify-content:center;gap:8px;
                                   ...
                                   letter-spacing:.04em;
                                   box-shadow:0 4px 16px rgba(209,52,56,.35);
                                   cursor:pointer;transition:filter .15s,transform .15s;"
                            onmouseover="this.style.filter='brightness(.92)'"
                            onmouseout="this.style.filter=''"
                            onmousedown="this.style.transform='scale(.98)'"
